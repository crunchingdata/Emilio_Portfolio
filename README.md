...
* Solution: Weighting the values of the Model with minor absolute values with a faktor, so that values of Model 1 and Model 2 have in total the same length.
## Instructions of use
