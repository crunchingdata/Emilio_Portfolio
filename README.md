...
* Created a Anaconda environment for Power BI and connected Power BI Desktop to it. User Interface of Power BI Service can not display directly Python visuals, for full display use Power BI Desktop.
