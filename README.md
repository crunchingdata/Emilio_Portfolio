...
Secondly, with Model 2 I applied a common forecast technic for a trend continuing past developement, thus weighting yearly return from current return back to the return of past years with exponential decay. Model 2 was necesary to control in Model 3 with an often used metric here the Exponential Moving Average (EMA) over years to confirm return estimation.
